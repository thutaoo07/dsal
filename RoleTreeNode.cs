...
namespace ExperimentTreeViewV2.Classes
{
    ...
    internal class RoleTreeNode:TreeNode, ISerializable
    {
        ...
        public RoleTreeNode(Role role, RoleTreeNode parent = null)
: base(role.Name) // Set the base TreeNode text to the role name
        {
            _role = role;
            _parentRoleTreeNode = parent;
            _children = new List<RoleTreeNode>();

            if (parent != null)
            {
                parent.ChildRoleTreeNodes.Add(this);
